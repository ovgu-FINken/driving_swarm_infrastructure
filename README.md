...
```
In addition you need to instal the following python packages: `python3-pykdl`, `python3-termcolor`, `scikit-image`, `shapely`, `graph-tool`, `python3-scipy`, `deprecation`, `dubins`
