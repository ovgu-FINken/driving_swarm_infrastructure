...
setup(
    ...
    entry_points={
        'console_scripts': [
            ...
            'ccr_global_planner_aco = ccr.ccr_global_planner_aco:main',
            'ccr_global_planner_RL = ccr.ccr_global_planner_RL:main',
            'ccr_global_planner_joint_markov = ccr.ccr_global_planner_joint_markov:main',
